...
export default function Home() {
  return (
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          <h1 className="text-[50px] text-white font-semibold">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-red-500"> Hoang Vu</span>
          </h1>
          <p className="text-gray-200 hidden md:block">
            My purpose in studying IT is to develop problem-solving skills, grasp modern technology, and contribute to
            creative projects, improving work efficiency in a professional environment.
          </p>
      ...
      <div className="absolute right-5 top-1/2 transform -translate-y-1/2 z-[30] transition-transform duration-500 hover:scale-110">
        <Image src="/tachnenn.png" alt="Avatar" width={300} height={300} className="rounded-[30px] " />
      </div>
    </main>
  );
}
